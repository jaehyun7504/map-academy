  ...
  <div className="About">
    <div className="About-philosophy">
      ...
      <p className="About-paragraph">
        이것이 맵학원의 교육 철학입니다. 마중물을 부어주면서 펌프질을 해야 물이
        나옵니다. 하지만 흘러 나오는 물은 이미 지하에 있었지 새로 만들어진 것이
        아닙니다. 교육은 창조행위가 아니라 아이가 이미 가지고 있는 능력을
        끌어내는 마중물과 같은 것입니다. 교육자는 교육 과정을 창조적으로
        운영해야 하지만 자신이 창조자라는 교만에 빠지면 안됩니다.
      </p>
    ...
    <div className="About-container">
      <div className="About-motto">
        ...
        <h2 className="About-heading-2">CHANGE</h2>
      </div>
